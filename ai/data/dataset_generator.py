...
dataset = generator.generate_dataset(600)
total_size = generator.generate_most_recent_dataset(225)
print(total_size)


# 파일 경로 설정
project_root = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', '..'))
file_path = os.path.join(project_root, 'ai', 'data', 'augmentation_template_dataset.json')
